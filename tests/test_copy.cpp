...
BOOST_AUTO_TEST_CASE(copyNone) {
    cache_map<int,string,policy_none> c1(3);
    ...
    cache_map<int,string,policy_none> c2(c1);
...
BOOST_AUTO_TEST_CASE(copyLRU) {
    cache_map<int,string,policy_lru> c1(3);
    ...
    cache_map<int,string,policy_lru> c2(c1);
...
BOOST_AUTO_TEST_CASE(copyMRU) {
    cache_map<int,string,policy_mru> c1(3);
    ...
    cache_map<int,string,policy_mru> c2(c1);
...
BOOST_AUTO_TEST_CASE(copyLFU) {
    ...
    cache_map<int,string,policy_lfu> c2(c1);
...
BOOST_AUTO_TEST_CASE(copyLFUStar) {
    cache_map<int,string,policy_lfustar> c1(3);
    ...
    cache_map<int,string,policy_lfustar> c2(c1);
...
BOOST_AUTO_TEST_CASE(copyLFUAging) {
    cache_map<int,string,policy_lfuaging<3600> > c1(3);

    c1.insert(1,"data1");
    c1.insert(2,"data2");
    c1.insert(3,"data3");

    cache_map<int,string,policy_lfuaging<3600> > c2(c1);
...
BOOST_AUTO_TEST_CASE(copyLFUAgingStar) {
    ...
    cache_map<int,string,policy_lfuagingstar<1> > c2(c1);
...
BOOST_AUTO_TEST_CASE(copyAdaptive) {
    ...
    cache_map<int,string,policy_adaptive> c2(c1);
