...
#ifndef STLCACHE_STLCACHE_MAP_HPP_INCLUDED
#define STLCACHE_STLCACHE_MAP_HPP_INCLUDED
...
namespace stlcache {
    ...
    >
    class cache_map {
		using storageType = std::map<Key,Data,Compare,Allocator<std::pair<const Key, Data>>> ;
    ...
    public:
        ...
        /*! \brief storage object accessor
          ...
          */
        const storageType& get_storage() const {
        	return _storage ;
        }
         ...
         * \see cache::operator= 
         */
        void swap ( cache_map<Key,Data,Policy,Compare,Allocator>& mp ) throw(exception_invalid_policy) {
         ...
         * \see swap 
         */
        cache_map<Key,Data,Policy,Compare,Allocator>& operator= ( const cache_map<Key,Data,Policy,Compare,Allocator>& x) throw() {
         ...
         *  \param <x> a cache object with the same template parameters 
         */
        cache_map(const cache_map<Key,Data,Policy,Compare,Allocator>& x) throw() {
            *this=x;
        }
        /*!
         ...
         * 
         */
        explicit cache_map(const size_type size, const Compare& comp = Compare()) throw() {
