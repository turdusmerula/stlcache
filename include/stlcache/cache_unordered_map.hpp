...
#ifndef STLCACHE_STLCACHE_UNORDERED_MAP_HPP_INCLUDED
#define STLCACHE_STLCACHE_UNORDERED_MAP_HPP_INCLUDED
...
namespace stlcache {
    ...
    >
    class cache_unordered_map {
        typedef std::unordered_map<Key,Data,Compare,Allocator<std::pair<const Key, Data> > > storageType;
    ...
    public:
         ...
         * \see cache::operator= 
         */
        void swap ( cache_unordered_map<Key,Data,Policy,Compare,Allocator>& mp ) throw(exception_invalid_policy) {
         ...
         * \see swap 
         */
        cache_unordered_map<Key,Data,Policy,Compare,Allocator>& operator= ( const cache_unordered_map<Key,Data,Policy,Compare,Allocator>& x) throw() {
         ...
         *  \param <x> a cache object with the same template parameters 
         */
        cache_unordered_map(const cache_unordered_map<Key,Data,Policy,Compare,Allocator>& x) throw() {
            *this=x;
        }
        /*!
         ...
         * 
         */
        explicit cache_unordered_map(const size_type size, const Compare& comp = Compare()) throw() {
...
#endif /* STLCACHE_STLCACHE_UNORDERED_MAP_HPP_INCLUDED */
